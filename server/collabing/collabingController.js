...
var Collab = require('../collab/collabModel.js')

module.exports = {
  getCollab: function(req, res) {
    // if(COLLAB) console.log("COLLAB MODEL EXISTS");
    console.log("REQ BODY: ", req.body);
    Collab.findOne({roomhash: req.body.collabHash}, function(err, collabRoom){
      console.log("COLLABROOM: ", collabRoom);
      var options = {
        // url: 'https://www.codewars.com/api/v1/code-challenges/5513795bd3fafb56c200049e/javascript/train',
        url: 'https://www.codewars.com/api/v1/code-challenges/'+ collabRoom.challengeName + '/javascript/train',
        headers: {
  ...
  attemptCollab: function(req, res) {
